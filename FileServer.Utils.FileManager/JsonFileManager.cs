...
namespace FileServer.Utils.FileManager
{
    public class JsonFileManager : FileManager
    {
        ...
        public override void CreateFile()  // crear fichero
        {
            if (!FileExists()) // comprueba si existe, devuelve bool
            {
                try
                {
        ...
        public override string RetrieveData() //coge texto del json y lo devuelve
        {
            try
            {
        ...
        public override Alumno ProcessAlumnoData(Alumno alumno) // aqui variará dependiendo si es json, txt, xml
        {
